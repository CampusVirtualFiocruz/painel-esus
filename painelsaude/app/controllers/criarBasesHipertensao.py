...
def criarBasesHipertensao(path):
    ...
    tb_fat_at_ind_2018_2019_2020_SELECTED['isContained_HIPERTENSAO'] = tb_fat_at_ind_2018_2019_2020_SELECTED.astype(
        str).apply(string_finder, words=match, axis=1)

    # Atendimentos identificamos pelo CID ou CIAP PN
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO = tb_fat_at_ind_2018_2019_2020_SELECTED[(
        tb_fat_at_ind_2018_2019_2020_SELECTED['isContained_HIPERTENSAO'] == True)]
    ...
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['ds_agravo_1'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO.astype(
        str).apply(string_finder, words=match, axis=1)

    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_nom_1"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_1"] == True, 'Infarto Agudo do Miocárdio', '')
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_cod_1"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_1"] == True, 'I21, I210, I211,I212, I213, I214, I219', '')
    ...
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['ds_agravo_2'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO.astype(
        str).apply(string_finder, words=match, axis=1)

    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_nom_2"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_2"] == True, 'Acidente Vascular Encefálico', '')
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_cod_2"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_2"] == True, 'I64', '')
    ...
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['ds_agravo_3'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO.astype(
        str).apply(string_finder, words=match, axis=1)

    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_nom_3"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_3"] == True, 'Doença renal', '')
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_cod_3"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_3"] == True, 'I12,I129,I13,I130,I131,I132,I139,N083,N179,N18,N180,N188,N189,N19,​​U14,U99,U88,U90', '')
    ...
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['ds_agravo_4'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO.astype(
        str).apply(string_finder, words=match, axis=1)

    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_nom_4"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_4"] == True, 'Doença Coronariana', '')
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_cod_4"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_4"] == True, 'I24,I248,I249,I25,I251,I258,I259,I518,I519,I110,I119,I130,I132,I50,I500,I509', '')
    ...
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['ds_agravo_5'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO.astype(
        str).apply(string_finder, words=match, axis=1)

    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_nom_5"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_5"] == True, 'Doença Cerebrovascular', '')
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_cod_5"] = np.where(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO["ds_agravo_5"] == True, 'G46,G468,I67,I678,I679,I68,I688,I69,I699', '')
    ...
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['FAIXA_ETARIA_HIPERTENSO'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO.apply(
    ...
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO.replace(
        r'^s*$', float('NaN'), regex=True)
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO.dropna(
        subset=["co_fat_cidadao_pec"], inplace=True)

    """### Take Last Peso & Altura for Calculating IMC"""

    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_peso_last'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_peso'].str.split(
        ',').str[-1]
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_altura_last'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_altura'].str.split(
        ',').str[-1]

    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_peso_last'] = pd.to_numeric(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_peso_last'], errors='coerce')
    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_altura_last'] = pd.to_numeric(
        tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_altura_last'], errors='coerce')

    tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO[
        'nu_altura_last_M'] = tb_fat_at_ind_2018_2019_2020_SELECTED_HIPERTENSAO['nu_altura_last'] / 100
