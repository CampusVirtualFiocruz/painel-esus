...
pregnants_bp = Blueprint('pregnants_bp', __name__)


@pregnants_bp.route('/v1/pregnants/prenatal-indicators', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/prenatal-indicators/<nu_cnes>', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/obstetrics-factors', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/obstetrics-factors/<nu_cnes>', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/per-weeks', methods=['GET'])
@token_required
def pregnatsPerages():
    pregnantsData = PregnantsBase()
    data = pregnantsData.getBase()
...
@pregnants_bp.route('/v1/pregnants/per-weeks/<nu_cnes>', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/total-per-trimester', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/total-per-trimester/<nu_cnes>', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/per-trimester/<trimester>', methods=['GET'])
@token_required
def pregnatsByTrimester(trimester):
    ...
    pregnants = PregnantsService()
    try:
        result = pregnants.pregnantsByTrimester(
            data, trimester, page, pregnantsData, con)
...
@pregnants_bp.route('/v1/pregnants/per-trimester/<trimester>/<nu_cnes>', methods=['GET'])
@token_required
def pregnatsByTrimesterBynu_cnes(trimester, nu_cnes):
    ...
    try:
        result = pregnants.pregnantsByTrimester(
            data, trimester, page, pregnantsData, con, nu_cnes)
        return jsonify({'message': 'successfully fetched', 'data': result[0], 'total': result[1]})
    except Exception as e:
        return jsonify({'message': 'Error',  'data': 'Error on getting pregnants information'+str(e)}), 500


@pregnants_bp.route('/v1/pregnants/per-weekly-range/<weekly>', methods=['GET'])
@token_required
def pregnatsByWeekly(weekly):
    ...
    pregnants = PregnantsService()
    try:
        result = pregnants.pregnantsWeeklyRange(
            data, weekly, page, pregnantsData, con)
        return jsonify({'message': 'successfully fetched', 'data': result[0], 'total': result[1]})
    except Exception as e:
        return jsonify({'message': 'Error',  'data': 'Error on getting pregnants information. '+str(e)}), 500


@pregnants_bp.route('/v1/pregnants/per-weekly-range/<weekly>/<nu_cnes>', methods=['GET'])
@token_required
def pregnatsByWeeklyBynu_cnes(weekly, nu_cnes):
    ...
    try:
        result = pregnants.pregnantsWeeklyRange(
            data, weekly, page, pregnantsData, con, nu_cnes)
        return jsonify({'message': 'successfully fetched', 'data': result[0], 'total': result[1]})
    except Exception as e:
        return jsonify({'message': 'Error',  'data': 'Error on getting pregnants information'+str(e)}), 500


@pregnants_bp.route('/v1/pregnants/exams-table', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/exams-table/<nu_cnes>', methods=['GET'])
@token_required
...
@pregnants_bp.route('/v1/pregnants/pregnants-table', methods=['GET'])
@token_required
def pregnantstable():
    try:
        page = 1
        ...
        response = pregnants.pregnantsTable(
            data, mestre, page, pregnantsData, con)
...
@pregnants_bp.route('/v1/pregnants/pregnants-table/<nu_cnes>', methods=['GET'])
@token_required
def pregnantstableBynu_cnes(nu_cnes):
    try:
        ...
        response = pregnants.pregnantsTable(
            data, mestre, page, pregnantsData, con, nu_cnes)
        return jsonify({'message': 'successfully fetched', 'data': response[0], 'total': response[1]})
    except Exception as e:
        return jsonify({'message': 'Error',  'data': 'Error on getting pregnants  table information. '+str(e)}), 500


@pregnants_bp.route('/v1/pregnants/by-id/<pec>', methods=['GET'])
@token_required
