...
@app.route('/v1/arterial-hypertension/total', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/total/<nu_cnes>', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/age-group-location', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/age-group-location/<nu_cnes>', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/age-group-gender', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/age-group-gender/<nu_cnes>', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/complications', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/complications/<nu_cnes>', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/imc', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/imc/<nu_cnes>', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/proffessionals', methods=['GET'])
@token_required
def arterialHypertensionProffessionals():
    ...
    try:
        ...
        base.apply( lambda row: hearAttackProfessionalsList.pipelineFn(row), axis=1)
...
@app.route('/v1/arterial-hypertension/proffessionals/<nu_cnes>', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/exams', methods=['GET'])
@token_required
...
@app.route('/v1/arterial-hypertension/exams/<nu_cnes>', methods=['GET'])
@token_required
...
@app.route('/v1/get-hypertensive-list', methods=['GET'])
@token_required
