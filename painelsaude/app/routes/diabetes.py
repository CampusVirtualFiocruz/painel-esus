...
from app.models.AttackModel import DiabeticDiseaseModel
...
@diabetes_bp.route('/v1/diabetes/total', methods=['GET'])
@token_required
def diabetesTotal():
...
@diabetes_bp.route('/v1/diabetes/total/<nu_cnes>', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/age-group-location', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/age-group-location/<nu_cnes>', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/age-group-gender', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/age-group-gender/<nu_cnes>', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/complications', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/complications/<nu_cnes>', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/imc', methods=['GET'])
@token_required
def diabetesIMC():
    diabetes = DiabetesBase()
    base = diabetes.findByCnes()
...
@diabetes_bp.route('/v1/diabetes/imc/<nu_cnes>', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/professionals', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/proffessionals/<nu_cnes>', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/diabetes/exams', methods=['GET'])
@token_required
def diabetesExams():
    diabetes = DiabetesBase()
    base = diabetes.findByCnes()
...
@diabetes_bp.route('/v1/diabetes/exams/<nu_cnes>', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/get-diabetes-list', methods=['GET'])
@token_required
...
@diabetes_bp.route('/v1/get-diabetes-list/<nu_cnes>', methods=['GET'])
@token_required
