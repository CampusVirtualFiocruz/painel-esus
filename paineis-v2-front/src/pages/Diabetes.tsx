...
export function Diabetes() {
    ...
    const { data: dataDiabetesAgeGroupGender, isLoading: isLoadingDiabetesAgeGroupGender, error: errorDiabetesAgeGroupGender } = useQuery(['diabetes-age-group-gender', paramRoute], async () => {
        let path = id ? `diabetes/age-group-gender/${id}` : 'diabetes/age-group-gender';
    ...
    const { data: dataDiabetes, isLoading: isLoadingDiabetes, error: errorDiabetes } = useQuery(['diabetes-age-group-location', paramRoute], async () => {
        let path = id ? `diabetes/age-group-location/${id}` : 'diabetes/age-group-location';
        const response = await Api.get(path);
        const responseData = response.data;
    ...
    const { data: dataDiabetesIndicators, isLoading: isLoadingDiabetesIndicators, error: errorDiabetesIndicators } = useQuery(['diabetes-complications', paramRoute], async () => {
    ...
    const { data: dataDiabetesFactors, isLoading: isLoadingDiabetesFactors, error: errorDiabetesFactors } = useQuery(['diabetes-factors-imc', paramRoute], async () => {
    ...
    const { data: dataExamsTable, isLoading: isLoadingExamsTable, error: errorExamsTable } = useQuery(['diabetes-exams', paramRoute], async () => {
                    ...
                    <div className="row gx-5">
                        <div className="col-12 col-lg-5">
                            <div className="painel-lateral">
                                <h4 className="mt-5 text-center">Pessoas com diabetes por faixa etária</h4>
                                {isLoadingDiabetes ? (
                                    ...
                                    <Bar data={dataDiabetes} titulo="Total de pessoas com diabetes no município" />
                                )}
                            </div>

                            <div className="painel-lateral">
                                <h4 className="mt-5 text-center">Pessoas com diabetes por sexo</h4>
                                {isLoadingDiabetesAgeGroupGender ? (
                                    ...
                                    <BarSexo data={dataDiabetesAgeGroupGender} titulo="Total de pessoas com diabetes no município" />
                                )}
                            </div>
                        ...
                        <div className="col-12 col-lg-7 d-flex flex-column">
                            ...
                            <div className="painel-secundario my-2">
                                <h4 className="my-4 text-center">Frequência de complicações relacionadas à diabetes</h4>
                                ...
                                <div className="d-flex flex-wrap flex-xl-nowrap justify-content-center">
                                    {isLoadingDiabetesIndicators ? (
                                        ...
                                        <>
                                            {dataDiabetesIndicators?.map((indicador: any, i: number) => <Donut key={i} data={indicador} />)}
                                        </>
                                    )}
                                </div>
                            ...
                            <div className="painel-secundario">
                                <h4 className="mt-5 mb-4 text-center">Adultos com diabetes de acordo com o IMC</h4>
                                ...
                                <div className="d-flex flex-wrap flex-lg-nowrap justify-content-center">
                                    {isLoadingDiabetesFactors ? (
                                        ...
                                        <>
                                            {dataDiabetesFactors?.map((diabete: any, i: number) => <Pie key={i} data={diabete} />)}
                                        </>
                                    )}
                                </div>
                            </div>
