...
export function SelecionarUbs() {
    ...
    const { data, isLoading, error } = useQuery('ubs', async () => {
            ...
            <div className="contentWrapper">
                ...
                <div className="container-escolher-ubs d-flex flex-column flex-md-row align-items-center">
                    ...
                    <div className="container-combo-ubs ms-md-4">
                        {isLoading ?
                            (
                                <div className="combo-ubs d-flex align-items-center justify-content-center"><Spinner size="sm" /> Carregando lista de UBS's</div>
                            ) : error ? (
