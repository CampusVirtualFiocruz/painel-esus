          ...
          <div className="row align-items-start">
            <div className="col-12">
              <ul>
                <li>
                  <a
                    className="relatorio-link"
                    href="./Painel/P10.html"
                    target="_blank"
                  >
                    Boas práticas na APS - Indicador P10 - Ferida Vascular
                  </a>
                </li>
                <li>
                  <a
                    className="relatorio-link"
                    href="./Painel/P11.html"
                    target="_blank"
                  >
                    Boas práticas na APS - Indicador P11 - Tuberculose
                  </a>
                </li>
                <li>
                  <a
                    className="relatorio-link"
                    href="./Painel/P12.html"
                    target="_blank"
                  >
                    Boas práticas na APS - Indicador P12 - Hanseníase
                  </a>
                </li>
                <li>
                  <a
                    className="relatorio-link"
                    href="./Painel/P13.html"
                    target="_blank"
                  >
                    Boas práticas na APS - Indicador P13 - Tabagismo
                  </a>
                </li>
              </ul>
            </div>
