...
const useReportDataInfantil = ({ ubsId, equipe }: reportBasicInfo) => {
  ...
  const totalAtendimentosQuery = useQuery(
    ...
    async () => {
      const response = await Api.get(
        `/children/total-medical-cares${ubsParam}`,
        defaultParam
      );
      return response?.data?.data || response.data;
    },
  ...
  const criancasFaixaEtariaSexoQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['criancas-por-sexo']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const distribuicaoCriancasRacaCorQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['distribuicao-criancas-raca-cor']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const primeiraConsulta8DiaQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['primeira-consulta-ate-8-dia']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const noveConsultas2AnosQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['nove-consultas-puericultura-2-anos']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const umaVisita30DiasQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['uma-visita-domiciliar-acs-tacs-30dias']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const umaVisita31Dia6MesesQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['uma-visita-domiciliar-acs-tacs-31dias-a-6meses']
          ?.data ||
        response?.data?.data ||
        response.data
      );
  ...
  const umaConsulta12MesesQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['consulta-odonto-ate-12-meses']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const umaConsulta12_24MesesQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['consulta-odonto-12-24-meses']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const registroPesoAlturaQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['registro-peso-altura-puericultura-9-consultas']
          ?.data ||
        response?.data?.data ||
        response.data
      );
  ...
  const marcosDesenvolvimentoAvaliadosQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['marco-desenvolvimento-avaliados']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const consumoAlimentarAvaliadoQuery = useQuery(
    ...
    async () => {
      ...
      return (
        response.data?.['consumo-alimentar-avaliado']?.data ||
        response?.data?.data ||
        response.data
      );
    },
  ...
  const loadings = {
    ...
    'infantil-criancas-faixa-etaria-sexo':
      criancasFaixaEtariaSexoQuery.isLoading,
    'infantil-distribuicao-criancas-raca-cor':
      distribuicaoCriancasRacaCorQuery.isLoading,
    ...
    'infantil-marcos-desenvolvimento-avaliados':
      marcosDesenvolvimentoAvaliadosQuery.isLoading,
    'infantil-consumo-alimentar-avaliado':
      consumoAlimentarAvaliadoQuery.isLoading,
  };
  ...
  const errors = {
    ...
    'infantil-distribuicao-criancas-raca-cor':
      distribuicaoCriancasRacaCorQuery.error,
    ...
    'infantil-marcos-desenvolvimento-avaliados':
      marcosDesenvolvimentoAvaliadosQuery.error,
  ...
  const data = {
    ...
    'infantil-distribuicao-criancas-raca-cor':
      distribuicaoCriancasRacaCorQuery.data,
    ...
    'infantil-marcos-desenvolvimento-avaliados':
      marcosDesenvolvimentoAvaliadosQuery.data,
