...
const reportQueryKey = "relatorio-diabetes--";
const reportRoute = "/diabetes/";
const config = {
  staleTime: 1000 * 60 * 10,
};

const useReportDataDiabetes = ({ ubsId, equipe }: reportBasicInfo) => {
...
export default useReportDataDiabetes;
