...
export function bodyPrimeiroTrimestre() {
    return (
        <div className="d-flex flex-column">
            ...
            <p className="mb-1">As consultas devem ser realizadas conforme este cronograma:</p>
            <ul className="ms-4">
            ...
            <p className="my-4">Avaliar prescrição de ácido fólico e sulfato ferroso.</p>
        </div>
    );
}
export function bodySegundoTrimestre() {
    return (
        <div className="d-flex flex-column">
            ...
            <p>caso necessário, o segundo trimestre é o período mais adequado para a realização de intervenções clínicas e procedimentos odontológicos essencias, sempre de acordo com as indicações.</p>
        </div>
    );
}
export function bodyTerceiroTrimestre() {
    return (
        <div className="d-flex flex-column">
            ...
            <p className="my-4">Encaminhar gestante para avaliação de bem-estar fetal após 41 semanas de gestação</p>
    ...
    return (
        <div className="d-flex flex-column mb-4">
            ...
            <ul className="ms-4">
                ...
                <li className="mb-1">- Realizar exame físico (edema, altura uterina, PA, mamas)</li>
                <li className="mb-1">- Avaliar resultado de exames complementares</li>
                <li className="mb-1">- Atualizar o Cartão de Gestante e a Ficha Pré-Natal</li>
                <li className="mb-1">- Registrar as informações</li>
                <li className="mb-1">- Acompanhar ganho de peso gestacional</li>
                <li className="mb-1">- Avaliar batimentos cardiofetais e movimentações do bebê</li>
...
export function bodyBoasPraticasAssistenciaPessoaDiabetes() {
    return (
        <div className="d-flex flex-column mb-4">
            <h1 className="mb-4">Boas práticas no cuidado de pessoas com diabetes:</h1>
            <ul className="ms-4">
                <li className="mb-1">- Orientar sobre efeitos deletérios do tabagismo</li>
                <li className="mb-1">- Monitorar a pressão arterial</li>
                <li className="mb-1">- Orientar quanto ao uso de medicações, quando houver</li>
                <li className="mb-1">- Orientar quanto ao exame e cuidados com o pé diabético</li>
                <li className="mb-1">- Realizar o controle glicêmico</li>
                <li className="mb-1">- Realizar avaliação antropométrica (IMC e Circunferência abdominal)</li>
                <li className="mb-1">- Realizar orientação nutricional (individual ou em grupo)</li>
...
export function bodyBoasPraticasCuidadoPessoasHipertensao() {
    return (
        <div className="d-flex flex-column mb-4">
            <h1 className="mb-4">Boas práticas no cuidado de pessoas com hipertensão:</h1>
            <ul className="ms-4">
                <li className="mb-1">- Realizar avaliação antropométrica (IMC e Circunferência abdominal)</li>
                <li className="mb-1">- Realizar orientação nutricional (individual ou em grupo)</li>
                <li className="mb-1">- Acompanhamento multiprofissional</li>
