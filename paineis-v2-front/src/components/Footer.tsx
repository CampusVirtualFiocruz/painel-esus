  ...
  return (
    <footer id="footer">
      <div className="grid-sponsors">
        ...
        <img
          src={
            "https://www.rondonia.fiocruz.br/wp-content/uploads/2022/01/fiocruz.png"
          }
          className="img-fluid"
          alt="Fiocruz"
        ...
        <img
          src={
            "https://logodownload.org/wp-content/uploads/2017/02/sus-logo-0.png"
          }
          className="img-fluid"
          alt="Fiocruz"
          style={{ maxWidth: "170px" }}
        ...
        <img
          src={
            "https://www.gov.br/secom/pt-br/central-de-conteudo/manuais/uso-da-marca-do-governo-federal/2023_br_govfederal_marcaoficial_rgb.png/@@images/image"
          }
          className="img-fluid"
          alt="Fiocruz"
          style={{ maxWidth: "170px" }}
