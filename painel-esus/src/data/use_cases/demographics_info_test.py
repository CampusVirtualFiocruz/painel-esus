...
from .tests.data_frame_mocks.calc_age_data_frame import calc_age_df
from .tests.data_frame_mocks.demographics_info_df import (
    demographics_info_df,
    demographics_info_df_empty
)
from .tests.data_frame_mocks.atendimento_individual_df import (
...
def test_get_demographics_info(demographics_info_df):

    demographics_info = DemographicsInfo()
    response = demographics_info.get_demographics_info(demographics_info_df)
...
def test_get_demographics_info_when_empty_data(demographics_info_df_empty):
    demographics_info = DemographicsInfo()
    response = demographics_info.get_demographics_info(demographics_info_df_empty)
...
def test_get_demographics_info_when_invalid_argument():
    demographics_info = DemographicsInfo()
    with pytest.raises(InvalidArgument) as exc:
        demographics_info.get_demographics_info([])
