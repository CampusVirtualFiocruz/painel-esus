...
fci_vars_str = ", ".join(fci_vars)

EQUIPES = f"SELECT {fci_vars_str} FROM tb_fat_cad_individual order by co_seq_fat_cad_individual"
...
class CreateCadIndividualBaseRepository(CreateBasesRepositoryInterface):
    ...
    def create_base(self):
        try:
            ...
            print(f"Tempo total de execução fci: {execution_time:.2f} segundos")
