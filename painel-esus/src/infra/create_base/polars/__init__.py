...
from .create_fat_atvdd_coletiva_part_repository import CreateAtvddColetivaBaseRepository
...
from .create_fat_marca_consumo_alimnt_repository import CreateMarcaConsumoBaseRepository
