...
#    (pl.col("idade_dias").cast(pl.Int32) <= 1094) &  # Cast to Int32
#    (pl.col("obito") == 0) &
#    (pl.col("mudanca_territorio") == 0)
...
# ### Cálculo que serão utilizados em varios indicadores I - II e III V e VI

# Ter realizado a 1ª consulta por profissional médica(o) ou enfermeira(o) até a primeira semana de vida.
