...
def gerar_banco():
   ...
   # fai = pl.read_parquet(caminho_pasta+"tb_fat_atendimento_individual.parquet",columns=selected_columns_atd_ind)
    ...
    ).select("co_fat_cidadao_pec", "agg_visitas_domiciliares_acs","agg_alerta_visitas_domiciliares_acs","agg_dashboard_visitas_domiciliares_acs","total_visitas_domiciliares_acs")
