...
select distinct
		...
		from
			...
			left join tb_fat_cidadao_pec tfcp on tfcp.co_seq_fat_cidadao_pec = ce.co_fat_cidadao_pec
			join tb_acomp_cidadaos_vinculados p on p.co_cidadao = tfcp.co_cidadao
