...
def total_hipertension_diabetes(cnes: int = None, equipe: int = None):
    ...
    sql = f"""with 
                diabete_equipe as ( select distinct d.co_fat_cidadao_pec from  diabetes d join pessoas on pessoas.cidadao_pec = d.co_fat_cidadao_pec {where_clause}),
                hipertensao_equipe as ( select distinct d.co_fat_cidadao_pec from  hipertensao d join pessoas on pessoas.cidadao_pec = d.co_fat_cidadao_pec {where_clause}),
