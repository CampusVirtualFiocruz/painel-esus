...
from src.presentatios.controllers.tests.mocks.demographics_info_use_case_stub import (
...
def test_demographics_info_controller(demographics_info_use_case_mock):
    ...
    demographics_info_use_case_mock.get_demographics_info.assert_called_once_with(1)
...
def test_demographics_info_controller_with_none_argument(demographics_info_use_case_mock):
    ...
    response = controller.handle(request)
    assert isinstance(response, HttpResponse)
    demographics_info_use_case_mock.get_demographics_info.assert_called_once_with(None)
...
def test_demographics_info_controller_invalid_argument(demographics_info_use_case_repository_mock):
    ...
    controller = DemographicsInfoController(demographics_info_use_case_repository_mock)
