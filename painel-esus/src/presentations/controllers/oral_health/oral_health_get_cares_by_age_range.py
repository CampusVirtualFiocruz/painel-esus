...
class OralHealthGetCaresByAgeRangeController(ControllerInterface):
    ...
    def handle(self, request: HttpRequest) -> HttpResponse:
        ...
        response = self.__use_case.get_oral_health_cares_by_age_range(cnes)
        ...
        for item in response:
            if item['ds_faixa_etaria'] in response_parsed:
                for i in response_parsed[item['ds_faixa_etaria']]['axis']:
                    if i['label'] == item['ds_tipo_localizacao']:
