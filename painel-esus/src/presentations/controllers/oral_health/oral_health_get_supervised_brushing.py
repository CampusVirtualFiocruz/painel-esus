...
class OralHealthGetSupervisedBrushingController(ControllerInterface):
    ...
    def handle(self, request: HttpRequest) -> HttpResponse:
        ...
        response = self.__use_case.oral_health_get_supervised_brushing(
            cnes, equipe, category
        )
        adapted_response = self.__adapter.supervised_brushing(response)
