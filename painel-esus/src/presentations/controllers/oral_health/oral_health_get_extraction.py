...
class OralHealthGetExtractionController(ControllerInterface):
    ...
    def handle(self, request: HttpRequest) -> HttpResponse:
        ...
        response = self.__use_case.get_oral_health_extraction(cnes, equipe, category)
        adapted_response = self.__adapter.extraction(response)
