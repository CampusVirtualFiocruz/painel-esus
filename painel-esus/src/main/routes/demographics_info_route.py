...
from src.main.composers.demographics_info_composer import \
    demographics_info_composer
...
@demographics_info_bp.route(
    f"{urls['root']}", methods=["GET"], endpoint="get_demographics_info"
)
@demographics_info_bp.route(
    f"{urls['root']}/<cnes>", methods=["GET"], endpoint="get_demographics_info_id"
)
@cache.cached()
