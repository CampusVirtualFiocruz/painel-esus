...
class AlertRecord:
    def __init__(self, descricao: str, data, exibir_alerta, tipo_alerta: str,):
...
class HypertensionNominalListAdapter:
    ...
    def __init__(self, user: HipertensaoNominal):
        ...
        self.possui_alertas = (
            user.alerta_afericao_pa or user.alerta_creatinina or
            user.alerta_total_de_consultas_medico or user.alerta_ultima_consulta_medico or user.alerta_ultima_consulta_odontologica or
...
class DiabetesNominalListAdapter:
    ...
    def __init__(self, user: DiabetesNominal):
        ...
        self.tipo_localidade = user.ds_tipo_localizacao
        self.possui_alertas = (
            user.alerta_afericao_pa or user.alerta_total_de_consultas_medico or user.alerta_ultima_consulta_medico or user.alerta_ultima_consulta_odontologica or
            user.alerta_visita_acs or user.alerta_ultima_hemoglobina_glicada or user.alerta_ultima_glicemia_capilar
        )
        self.cpf = user.nu_cpf
        self.cns = user.nu_cns
        self.idade = user.idade
        ...
        if user.alerta_ultima_hemoglobina_glicada:
            self.registros.append(AlertRecord(
        ...
        if user.alerta_ultima_glicemia_capilar:
            self.registros.append(AlertRecord(
